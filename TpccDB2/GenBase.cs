...
namespace Tpcc
{
    public class GenBase
    {
        ...
        public GenBase(DB2Connection c)
        {
            conn = c;
        }
        ...
        public void CreationScript()
        {
            ...
            cmd.CommandText="create table WAREHOUSE(" +
                "W_ID int not null primary key,W_NAME varchar(10),W_STREET_1 varchar(20)," +
                "W_STREET_2 varchar(20),W_CITY varchar(20),W_STATE char(2)," +
                "W_ZIP char(9),W_TAX numeric(4,4),W_YTD numeric(12,2))";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "create table DISTRICT(D_ID int not null," +
                "D_W_ID int not null references WAREHOUSE(W_ID),D_NAME varchar(10),D_STREET_1 varchar(20)," +
            ...
            cmd.CommandText = "create table HISTORY(" +
                ...
                "H_D_ID int not null,H_W_ID int not null,H_DATE date," +
            ...
            cmd.ExecuteNonQuery();
            cmd.CommandText = "create table \"ORDER\"(O_ID int not null," +
                "O_D_ID int not null,O_W_ID int not null,O_C_ID int not null,O_ENTRY_D date," +
                "O_CARRIER_ID int,O_OL_CNT int,O_ALL_LOCAL boolean,"+
            ...
            cmd.CommandText = "create table ITEM(" +
                "I_ID int not null primary key,I_IM_ID int,I_NAME varchar(24),I_PRICE numeric(5,2)," +
                "I_DATA varchar(50))";
            cmd.ExecuteNonQuery(); 
            cmd.CommandText = "create table STOCK(" +
                "S_I_ID int not null references ITEM(I_ID),S_W_ID int not null references WAREHOUSE(W_ID),S_QUANTITY numeric(4)," +
            ...
            cmd.CommandText = "create table ORDER_LINE(" +
                ...
                "OL_NUMBER int not null,OL_I_ID int not null,OL_SUPPLY_W_ID int not null," +
            ...
            cmd.CommandText = "create table DELIVERY(" +
                "DL_W_ID int not null,DL_ID int not null,DL_CARRIER_ID int," +
