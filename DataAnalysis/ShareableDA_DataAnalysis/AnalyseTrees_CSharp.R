...
SetUpDataSet <- function(){
  CollectionsTreeDataSet <- LoadDataSet("STreeTestOutput_CSharp.csv")
  SSTreeDataSet <- LoadDataSet("ShearableTreeTestOutput_CSharp.csv")
  
  CollectionsTreeDataSet$DA <- rep("ImmutableSortedDictionary",nrow(CollectionsTreeDataSet))
  SSTreeDataSet$DA <- rep("SSearchTree",nrow(SSTreeDataSet))
  
  fullDataSet<- rbind(CollectionsTreeDataSet, SSTreeDataSet)
  #print(fullDataSet)
  
}

plotInsertExecutionTime <- function(fullDataSet){
  newData <- fullDataSet[ which( (fullDataSet$TestCaseID=="ImmutableTree 100 insert") |
                                   (fullDataSet$TestCaseID=="SSearchTreeTest 100 insert")
  ), ]
  ...
  newData <- fullDataSet[ which( (fullDataSet$TestCaseID=="ImmutableTree 1000 insert") |
                                   (fullDataSet$TestCaseID=="SSearchTreeTest 1000 insert")
  ), ]
  ...
  newData <- fullDataSet[ which( (fullDataSet$TestCaseID=="ImmutableTree 10000 insert") |
                                   (fullDataSet$TestCaseID=="SSearchTreeTest 10000 insert")
  ), ]
