    ...
    public class Deferred
    {
        ...
        public Deferred(int w)
        {
            ...
            bool Schedule(int did, int carid)
            {
                ...
                db.Act("delete from new_order where no_w_id=" + wid + " and no_d_id=" + did + " and no_o_id=" + oid);
                cmd.CommandText = "select o_c_id from \"ORDER\" where o_w_id=" + wid + " and o_d_id=" + did + " and o_id=" + oid;
                ocid = (int)(long)cmd.ExecuteScalar();
                db.Act("update \"ORDER\" set o_carrier_id=" + carid + " where o_w_id=" + wid + " and o_d_id=" + did + " and o_id=" + oid);
                db.Act("update order_line set ol_delivery_d=date'" + DateTime.Now.ToString("yyyy-MM-dd") + "' where ol_w_id=" + wid + " and ol_d_id=" + did + " and ol_o_id=" + oid);
                decimal amount = 0.0M;
                ...
                db.Act("update customer set c_balance=c_balance+" + amount + ",c_delivery_cnt=c_delivery_cnt+1 where c_w_id=" + wid + " and c_d_id=" + did + " and c_id=" + ocid);
                return true;
            }
