...
namespace Shareable
{
    ...
    public class SDict<K,V> : Collection<(K,V)> where K: IComparable
    {
        /// <summary>
    ...
    public abstract class SBucket<K,V> : IBucket where K:IComparable
    {
        ...
        {
            Indent(i); Console.WriteLine(id.ToString());
        }
    }
    /// <summary>
    ...
    public class SLeaf<K,V> :SBucket<K,V> where K: IComparable
    {
        ...
        public override void Show(int i)
        {
            ...
            {
                Indent(i+1); Console.WriteLine(slots[c].Item1);
            }
        }
    }
    /// <summary>
