...
namespace Tpcc
{
   ...
   //        tr = db.BeginTransaction();
        ...
        bool FetchCustFromLast(ref string mess)
        {
            ...
            c_balance = (decimal)(double)s[13];
            c_ytd_payment = (decimal)(double)s[14];
        ...
        bool FetchCustFromId(ref string mess)
        {
            ...
            c_credit = (string)s[10];
            Set(29, c_credit);
            Set(37, ((decimal)(double)s[11]).ToString("F2"));
            Set(30, ((decimal)(double)s[12]).ToString("F4").Substring(1)); // c_discount
            Set(31, (string)s[8]); // c_phone
...
/*			if (activewh>1)
		...
		public Payment(OracleConnection c, int w)
        {
            db = c;
            wid = w;
            //
