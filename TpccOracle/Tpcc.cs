...
namespace Tpcc
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
        ...
        public Form1()
		{
			conn = new OracleConnection("Data Source=MyDb;User Id=c##Tpcc;Password=adminadmin");
            conn.Open();
			//
        ...
        public static void RecordRequest(OracleCommand cmd,int cid,int tid)
        {
            if (reqs == null)
                return;
            lock (reqs)
        ...
        {
                var conn = new OracleConnection("Data Source=MyDb;User Id=c##Tpcc;Password=adminadmin");
            conn.Open();
	...
	//			wid = int.Parse(textBox1.Text);
		...
		private void button2_Click(object sender, System.EventArgs e) // Run button for New Order
		{
            ...
            if (checkBox1.Checked)
            {
                ...
                n.db = new OracleConnection("Data Source=MyDb;User Id=c##Tpcc;Password=adminadmin");
            }
			n.btn = button2;
			n.txtBox = textBox3;
