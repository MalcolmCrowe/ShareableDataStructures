...
namespace Tpcc
{
    public class GenBase
    {
        ...
        public GenBase(OracleConnection c)
        {
            conn = c;
        }
        ...
        public void CreationScript()
        {
            ...
            cmd.CommandText="create table WAREHOUSE(" +
                ...
                "W_ZIP char(9),W_TAX numeric(4,4),W_YTD numeric(12,2)) initrans 200 maxtrans 200";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "create table DISTRICT(D_ID int," +
                ...
                "primary key (D_W_ID,D_ID)) initrans 200 maxtrans 200";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "create table CUSTOMER(" +
                ...
                "foreign key(C_W_ID,C_D_ID) references DISTRICT(D_W_ID,D_ID)) initrans 200 maxtrans 200";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "create table HISTORY(" +
                ...
                "foreign key (H_W_ID,H_D_ID) references DISTRICT(D_W_ID,D_ID))  initrans 200 maxtrans 200";
            cmd.ExecuteNonQuery(); 
            cmd.CommandText = "create table \"ORDER\"(O_ID int," +
                ...
                "foreign key(O_W_ID, O_D_ID,O_C_ID) references CUSTOMER(C_W_ID,C_D_ID,C_ID))  initrans 200 maxtrans 200";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "create table NEW_ORDER(" +
                "NO_O_ID int,NO_D_ID int,NO_W_ID int,"+
                "primary key(NO_W_ID, NO_D_ID, NO_O_ID),"+
                "foreign key(NO_W_ID, NO_D_ID, NO_O_ID) references \"ORDER\"(O_W_ID,O_D_ID,O_ID))  initrans 200 maxtrans 200";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "create table ITEM(" +
                "I_ID int primary key,I_IM_ID int,I_NAME varchar(24),I_PRICE numeric(5,2),"+
                "I_DATA varchar(50))  initrans 10000 maxtrans 10000";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "create table STOCK(" +
                ...
                "primary key(S_W_ID,S_I_ID))  initrans 200 maxtrans 200";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "create table ORDER_LINE(" +
                ...
                "foreign key(OL_SUPPLY_W_ID,OL_I_ID) references STOCK(S_W_ID,S_I_ID))  initrans 200 maxtrans 200";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "create table DELIVERY(" +
                "DL_W_ID int,DL_ID int,DL_CARRIER_ID int," +
                "DL_DONE int,DL_SKIPPED int,"+
                "primary key(DL_W_ID,DL_ID))  initrans 200 maxtrans 200";
            cmd.ExecuteNonQuery(); 
        }
        string NextData()
        {
        ...
        public void FillCustomer(int wid, int did)
        {
...
#endif
            {
                ...
                DateTime.Now.ToString("dd-MMM-yyyy") +"','"+ credit() + "',5000.00," +
                ...
                cmd.CommandText= "insert into HISTORY(" +
                    ...
                    cid + "," + did + "," + wid + "," + did + "," + wid + ",'" + DateTime.Now.ToString("dd-MMM-yyyy") + "',10.00," +
...
#endif
            {
                ...
                if (oid < 2101)
                {
                    ...
                    cmd.CommandText="insert into \"ORDER\"(" +
                        ...
                        wid + ",'"+DateTime.Now.ToString("dd-MMM-yyyy") + "'," + util.random(1, 10) + "," +
                        util.random(1, 15) + ",1)";
                    cmd.ExecuteNonQuery();
                }
                else
                {
                    ...
                    cmd.CommandText="insert into \"ORDER\"(" +
                        ...
                        oid + "," + (perm[oid - 1] + 1) + "," + did + "," +
                        wid + ",'"+DateTime.Now.ToString("dd-MMM-yyyy") + "'," + cnt + ",1)";
                    cmd.ExecuteNonQuery();
            ...
            for (int j = 1; j <= cnt; j++)
...
#endif
                        wid + ",'" + DateTime.Now.ToString("dd-MMM-yyyy") + "',5,0.00," +
                ...
                else
                {
                    ...
                    cmd.CommandText = "insert into ORDER_LINE(" +
                        ...
                        util.random(1, 100000) + "," +
#endif
                        wid + ",'" + DateTime.Now.ToString("dd-MMM-yyyy") + "',5," +
