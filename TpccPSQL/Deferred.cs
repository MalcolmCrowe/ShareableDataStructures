...
namespace Tpcc
{
	...
	public class Deferred
	{
		...
		{
            db = new NpgsqlConnection("Server=127.0.0.1; Port=5432; User Id=postgres; Password=Admin:1;Database=Tpcc");
            db.Open();
            wid = w;
		}

		bool Schedule(int did,int carid,NpgsqlTransaction tr)
		{
			int oid = 0;
			int ocid = 0;
