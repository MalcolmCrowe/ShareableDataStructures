...
namespace Pyrrho
{
    ...
    public class Resx
    {
        ...
        static void InitSqlstate()
        {
            ...
            dict.Add("40013", "Column {0} has just been dropped");
            dict.Add("40014", "Record {0} has just been deleted");
            ...
            dict.Add("40025", "Table {0} has just been altered");
            dict.Add("40026", "Integrity constraint: {0} has just been added");
            dict.Add("40027", "Integrity constraint: {0} has just been referenced");
            dict.Add("40029", "Record {0} has just been updated");
            dict.Add("40030", "A conflicting table {0} has just been defined");
            dict.Add("40031", "A conflicting view {0} has just been defined");
            dict.Add("40032", "A conflicting object {0} has just been defined");
            dict.Add("40033", "A conflicting trigger for {0} has just been defined");
            dict.Add("40034", "Table {0} has just been renamed");
            dict.Add("40035", "A conflicting role {0} has just been defined");
            dict.Add("40036", "A conflicting routine {0} has just been defined");
            dict.Add("40037", "An ordering now uses function {0}");
            dict.Add("40038", "Type {0} has just been renamed");
            dict.Add("40039", "A conflicting method {0} for {0} has just been defined");
            dict.Add("40040", "A conflicting period for {0} has just been defined");
            dict.Add("40041", "Conflicting metadata for {0} has just been defined");
            dict.Add("40042", "A conflicting index for {0} has just been defined");
            dict.Add("40043", "Columns of table {0} have just been changed");
            dict.Add("40044", "Column {0} has just been altered");
            dict.Add("40045", "A conflicting column {0} has just been defined");
            dict.Add("40046", "A conflicting check {0} has just been defined");
            dict.Add("40047", "Target object {0} has just been renamed");
            dict.Add("40048", "A conflicting ordering for {0} has just been defined");
            dict.Add("40049", "Ordering definition conflicts with drop of {0}");
            dict.Add("40050", "A conflicting namespace change has occurred");
            dict.Add("40051", "Conflict with grant/revoke on {0}");
            dict.Add("40052", "Conflicting routine modify for {0}");
            dict.Add("40053", "Domain {0} has just been used for insert");
            dict.Add("40054", "Domain {0} has just been used for update");
            dict.Add("40055", "An insert conflicts with drop of {0}");
            dict.Add("40056", "An update conflicts with drop of {0");
            dict.Add("40057", "A delete conflicts with drop of {0}");
            dict.Add("40058", "An index change conflicts with drop of {0}");
            dict.Add("40059", "A constraint change conflicts with drop of {0}");
            dict.Add("40060", "A method change conflicts with drop of type {0}");
            dict.Add("40068", "Domain {0} has just been altered,conflicts with drop");
            dict.Add("40069", "Method {0} has just been changed, conflicts with drop");
            dict.Add("40070", "A new ordering conflicts with drop of type {0}");
            dict.Add("40071", "A period definition conflicts with drop of {0}");
            dict.Add("40072", "A versioning change conflicts with drop of period {0}");
            dict.Add("40073", "A read conflicts with drop of {0}");
            dict.Add("40074", "A delete conflicts with update of {0}");
            dict.Add("40075", "A new reference conflicts with deletion of {0}");
            dict.Add("40076", "A conflicting domain or type {0} has just been defined");
            dict.Add("40077", "A conflicting change on {0} has just been done");
            dict.Add("40078", "Read conflict with alter of {0}");
            dict.Add("40079", "Insert conflict with alter of {0}");
            dict.Add("40080", "Update conflict with alter of {0}");
            dict.Add("40081", "Alter conflicts with drop of {0}");
            dict.Add("40082", "ETag validation failure");
            dict.Add("40083", "Secondary connection clnflict on {0}");
