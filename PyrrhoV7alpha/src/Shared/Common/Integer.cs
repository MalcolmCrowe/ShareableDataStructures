...
namespace Pyrrho.Common
{
	...
	internal class Integer : IComparable 
	{
        ...
        /// <summary>
        /// A table of powers of 10 to start off the server
        /// </summary>
		static byte[][] pow10 =
            [
                [1],
				...
				[1,134,160],
				[15,66,64],
				[0,152,150,128], // without the 0 it is a negative number!
				[5,245,225,0],
				[59,154,202,0],
				[2,84,11,228,0],
				[23,72,118,232,0],
				...
				[9,24,78,114,160,0],
				[90,243,16,122,64,0],
				[3,141,126,164,198,128,0],
				[35,134,242,111,193,0,0],
				[1,99,69,120,93,138,0,0],
				[13,224,182,179,167,100,0,0],
				[0,138,199,35,4,137,232,0,0],
				[5,107,199,94,45,99,16,0,0],
				[54,53,201,173,197,222,160,0,0],
				[2,30,25,224,201,186,178,64,0,0],
				[21,45,2,199,225,74,246,128,0,0],
				[0,211,194,27,206,204,237,161,0,0,0],
				[8,69,149,22,20,1,72,74,0,0,0],
				[82,183,210,220,200,12,210,228,0,0,0],
				[3,59,46,60,159,208,128,60,232,0,0,0],
				[32,79,206,94,62,37,2,97,16,0,0,0],
				[1,67,30,15,174,109,114,23,202,160,0,0,0],
				[12,159,44,156,208,70,116,237,234,64,0,0,0],
				[126,55,190,32,34,192,145,75,38,128,0,0,0],
				[4,238,45,109,65,91,133,172,239,129,0,0,0,0],
				[49,77,198,68,141,147,56,193,91,10,0,0,0,0],
				[1,237,9,190,173,135,192,55,141,142,100,0,0,0,0],
				[19,66,97,114,199,77,130,43,135,143,232,0,0,0,0],
				[0,192,151,206,123,201,7,21,179,75,159,16,0,0,0,0],
				[7,133,238,16,213,218,70,217,0,244,54,160,0,0,0,0],
				[75,59,76,168,90,134,196,122,9,138,34,64,0,0,0,0],
				[2,240,80,254,147,137,67,172,196,95,101,86,128,0,0,0,0],
				[29,99,41,241,195,92,164,191,171,185,245,97,0,0,0,0,0],
				[1,37,223,163,113,161,158,111,124,181,67,149,202,0,0,0,0,0],
				[11,122,188,98,112,80,48,90,223,20,163,217,228,0,0,0,0,0],
				[114,203,91,216,99,33,227,140,182,206,102,130,232,0,0,0,0,0],
				[4,123,241,150,115,223,82,227,127,36,16,1,29,16,0,0,0,0,0],
				[44,215,111,224,134,185,60,226,247,104,160,11,34,160,0,0,0,0,0],
				[1,192,106,94,197,67,60,96,221,170,22,64,111,90,64,0,0,0,0,0],
				[17,132,39,179,180,160,91,200,168,164,222,132,89,134,128,0,0,0,0,0],
				[0,175,41,141,5,14,67,149,214,150,112,177,43,127,65,0,0,0,0,0,0],
				[6,215,159,130,50,142,163,218,97,224,102,235,178,248,138,0,0,0,0,0,0],
				[68,108,59,21,249,146,102,135,210,196,5,52,253,181,100,0,0,0,0,0,0],
				[2,172,58,78,219,191,184,1,78,59,168,52,17,233,21,232,0,0,0,0,0,0],
				[26,186,71,20,149,125,48,13,14,84,146,8,179,26,219,16,0,0,0,0,0,0],
				[1,11,70,198,205,214,227,224,130,143,77,180,86,255,12,142,160,0,0,0,0,0,0],
				[10,112,195,196,10,100,230,197,25,153,9,11,101,246,125,146,64,0,0,0,0,0,0],
		];
        /// <summary>
		...
		public static Integer Parse(string str)
		{
			...
			while (n>=0)
			{
                if (!byte.TryParse(str.Substring(j, 1), out byte d))
                    throw new DBException("22G03", Domain.Int, str.Substring(j, 1));
				r += Pow10(n).Times(d);
				n--;
				j++;
			}
...
#region IComparable Members
    ...
    internal class Numeric : IComparable
	{
		...
		internal Numeric(Integer m,int s)
        {
			mantissa = m;
			scale = s;
		}
        ...
        /// <returns>The new Decimal</returns>
        internal Numeric Denormalise(int n)
        {
            if (n <= 0)
                return this;
            Integer m = mantissa;
...
#region IComparable Members
		...
		public int CompareTo(object? obj)
		{
            ...
            if (obj is int @int)
                ...
                throw new DBException("22G03", obj).Pyrrho()
