...
namespace Pyrrho.Common
{
    ...
    public enum Qlx
    {
        ...
        ASCENDING = 9,  
        ASIN = 10,
        ARRAY = 11, // must be 11 synonym for LIST in GQL (also see VECTOR)
        AT = 12,
        ATAN = 13,
        AVG = 14, 
        BIG = 15,  
        ...
        CONCATENATE = 248, // ||        
        DIVIDE = 249, // /        
        DOT = 250, // . 5.2 was STOP (see also Dot below for the DOT metric)
        ...
        DOMAIN = 427,
        Dot = 428,   // proposed GQL vector DOT metric (see also the token DOT .)
        ...
        GROUPING = 489,
        GROUPS = 490,
        HAMMING = 491,  // for vector distance
        HANDLER = 492, // vol 4 
        HIERARCHY = 493,
        ...
        SECTION = 721,
        SECURITY = 722,
        SELECT_STATEMENT = 723, // GQL
        SELF = 724,
        SENSITIVE = 725,
        SEQUENCE = 726,
        SERIALIZABLE = 727,
        SERVER_NAME = 728,
        SESSION_CLOSE_COMMAND = 729, // GQL
        SESSION_RESET_COMMAND = 730, // GQL
        SESSION_SET_BINDING_TABLE_PARAMETER_COMMAND = 731, // GQL
        SESSION_SET_PROPERTY_GRAPH_COMMAND = 732, // GQL
        SESSION_SET_PROPERTY_GRAPH_PARAMETER_COMMAND = 733, //GQL
        SESSION_SET_SCHEMA_COMMAND = 734, // GQL
        SESSION_SET_TIME_ZONE_COMMAND = 735, // GQL
        SESSION_SET_VALUE_PARAMETER_COMMAND = 736, // GQL
        SET_STATEMENT = 737, // GQL
        SETS = 738,
        SHORTEST = 739,
        SHOW = 740,
        SIGNAL = 741, //vol 4
        ...
        SPECIFICTYPE = 749,
        SQL = 750,
        SQLAGENT = 751, // Pyrrho 7
        SQLEXCEPTION = 752,
        SQLSTATE = 753,
        SQLWARNING = 754,
        STANDALONE = 755, // vol 14
        START_TRANSACTION_COMMAND = 756, // GQL
        STATE = 757,
        STATEMENT = 758,
        STATIC = 759,
        STRUCTURE = 760,
        ...
        SUBSTRING_REGEX = 766,
        SUCCEEDS = 767,
        SUFFIX = 768, // Pyrrho 7.01
        SYMMETRIC = 769,
        SYSTEM = 770,
        SYSTEM_TIME = 771,
        SYSTEM_USER = 772,  
        T = 773, 
        TABLESAMPLE = 774,// TABLE is 297
        TABLE_NAME = 775,
        TEMP = 776, // GQL
        TEMPORARY = 777,
        TIES = 778,
        ...
        TRAIL = 784,
        TRANSACTION = 785,
        TRANSACTION_ACTIVE = 786,
        TRANSACTIONS_COMMITTED = 787,
        TRANSACTIONS_ROLLED_BACK = 788,
        TRANSFORM = 789,
        TRANSFORMS = 790,
        TRANSLATE = 791,
        TRANSLATE_REGEX = 792,
        ...
        TRIGGER_CATALOG = 796,
        TRIGGER_NAME = 797,
        TRIGGER_SCHEMA = 798, // TYPE  is 267 but is not a reserved word
        TRIM_ARRAY = 799,
        TRUNCATE = 800,
        TRUNCATING = 801, // Pyrrho 7.07
        TYPE_URI = 802, // Pyrrho
        UESCAPE = 803,
        UNBOUNDED = 804,
        UNCOMMITTED = 805,
        ...
        URL = 816,  // Pyrrho 7
        USAGE = 817,
        USER_DEFINED_TYPE_CATALOG = 818,
        USER_DEFINED_TYPE_CODE = 819,
        USER_DEFINED_TYPE_NAME = 820,
        USER_DEFINED_TYPE_SCHEMA = 821,
        VALUE_OF = 822,
        VALUES = 823,
        VAR_POP = 824,
        VAR_SAMP = 825,
        VARYING = 826,
        VERSION = 827, // row-versioning: new for Pyrrho 7.09 April 2025
        VERSIONING = 828,
        VERTEX = 829, // GQL
        VIEW = 830,
        WHENEVER = 831,
