...
namespace tpcc
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private tpcc.DelReport delReport1;
		Thread thread = null;
        ...
        public Form1()
		{
			...
			db = new PyrrhoConnect("Provider=Pyrrho;Host="+host+";Files=Tpcc");
			db.Open();
		}
		...
		private void button2_Click(object sender, System.EventArgs e) // Run button for New Order
		{
            ...
            if (checkBox1.Checked)
            {
                ...
                n.db = new PyrrhoConnect("Host=" + host + ";Files=Tpcc_" + n.did + ",Tpcc");
                n.db.Open();
            }
			n.btn = button2;
			n.txtBox = textBox3;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (checkBox1.Checked)
            {
                ...
                IDbConnection c = new PyrrhoConnect("Host=" + host + ";Files=Tpcc_" + d + ",Tpcc");
                c.Open();
                new GenBase(c).FillDistrict(int.Parse(textBox1.Text),d);
            }
            else
                new GenBase(db).FillDistricts(int.Parse(textBox1.Text));
        }
