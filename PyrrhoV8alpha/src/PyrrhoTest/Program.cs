...
namespace Test
{
    ...
    "{B:8,\"JA.C\":3,D:82},{F: 11,\"JE.C\":4,G:10}]");
        ...
        /*    Begin(); withdrawn: Action 10F fails (correctly)
        ...
        void Test10F(int c) // withdrawn: v7.1 correctly finds a referencing conflict here
        {
            var p = new Program(new string[0]);
        ...
        void Test13()
        {
            ...
            if (qry == 0 || qry == 5)
            {
                CheckExceptionNonQuery(13, 5, "delete from ad where c='AB'", "RESTRICT");
                if (!commit)
                {
                    Begin();
        ...
        void Test14()
        {
            ...
            Act(217,"alter table se set foreign key(d) references fi on delete restrict");
            CheckExceptionNonQuery(14,2,"delete from fi where a = 2019","RESTRICT");
            if (!commit)
            {
                Begin();
            ...
            Act(224,"alter table se set foreign key(d) references fi on delete set null on update cascade");
        ...
        public void Test21()
        {
            ...
            conn.SetRole("MEMBERGAMES");
            Act(280,"call agree(2)");
            Act(281,"call claim(1,2)");
            conn.SetRole("ADMIN");
            CheckResults(21, 2, "table played", 
