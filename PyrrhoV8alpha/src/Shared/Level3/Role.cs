...
namespace Pyrrho.Level3
{
    ...
    internal class Role : DBObject
    {
        ...
        internal CTree<string, CTree<CList<Domain>,long>> procedures => 
            (CTree<string, CTree<CList<Domain>,long>>)(mem[Procedures]??CTree<string, CTree<CList<Domain>, long>>.Empty);
        internal CTree<string,long> nodeTypes =>
            (CTree<string, long>)(mem[NodeTypes]??CTree<string,long>.Empty);
        /// <summary>
        /// edgeTypes[name] gives the defining position of single EdgeType or a UNION of edgetypes
        /// </summary>
        internal CTree<string, long> edgeTypes =>
            (CTree<string, long>)(mem[EdgeTypes] ?? CTree<string, long>.Empty);
        internal CTree<CTree<string, bool>, long> unlabelledNodeTypesInfo =>
            (CTree<CTree<string, bool>, long>)(mem[UnlabelledNodeTypesInfo]
            ?? CTree<CTree<string, bool>, long>.Empty);
        internal CTree<CTree<string, bool>, long> unlabelledEdgeTypesInfo =>
    ...
    internal class ObInfo : Basis
    {
        internal const long
            ...
            Model = -274, // CTree<string,CTree<Qlx,long>> referenced domains and arrows
            Name = -50, // string
        ...
        public CTree<string, CTree<Qlx, long>> model => 
            (CTree<string, CTree<Qlx, long>>)(mem[Model] ?? CTree<string, CTree<Qlx, long>>.Empty);
        ...
        internal Table? etype => mem[Method.TypeDef] as Table;
        ...
        {
            d = d + (_Metadata, d.metadata + pm.metadata);
