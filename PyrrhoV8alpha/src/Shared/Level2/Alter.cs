...
namespace Pyrrho.Level2
{
    ...
    internal class Alter : PColumn
    {
        ...
        internal override DBObject? Install(Context cx)
        {
            ...
            cx.Install(tc);
            if ((table.colRefs.Count<=1L) && table.HasRefCols(cx.db) is CTree<long,CTree<long,bool>> er
                && er.Count>0 && table.defpos>0)
            {
	...
	internal class Alter3 : PColumn3
	{
        ...
        public Alter3(long co, string nm, int sq, Table tb, Domain dm,
            string ds,bool opt,Generation ge, long nst, long pp, Context cx) :
            base(Type.Alter3, tb, nm, dm, ds, opt, ge, nst, pp, cx)
		{
            seq = sq;
            _defpos = co;
		}
        ...
        /// </summary>
        /// <param name="r">Relocate some Ref references</param>
