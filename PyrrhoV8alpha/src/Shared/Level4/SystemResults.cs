...
namespace Pyrrho.Level4
{
    internal class SystemTable : Table
    {
        ...
        public CTree<int,long> sRowType => (CTree<int,long>?)mem[InstanceRowSet.SRowType] ?? CTree<int, long>.Empty;
        ...
        public static SystemTable operator+(SystemTable s,SystemTableColumn c)
        {
            ...
            return s + (SysCols, s.sysCols + (c.defpos, c)) + (Infos, s.infos+(s.role,oi))
                + (InstanceRowSet.SRowType, s.sRowType + ((int)s.sRowType.Count,c.defpos))
                + (RowType, s.rowType + ((int)s.rowType.Count, c.defpos))
    ...
    internal class SystemTableColumn : TableColumn
    {
        ...
        {
            t += (Domain.RowType, t.rowType + ((int)t.rowType.Count, defpos));
    ...
    internal class SystemIndex(long tb, Domain ks) : Level3.Index(--_uid,BTree<long, object>.Empty
    ...
    internal class SystemRowSet : TableRowSet
    {
        ...
        internal new CTree<int,long> rowType => sRowType;
        /// <summary>
        ...
        static SystemRowSet()
        {
            ...
            RoleExpectResults();
            RoleGraphResults();
            RoleGraphNodeResults();
            RoleGraphScenarioResults();
            RoleIndexResults();
            RoleIndexKeyResults();
            RoleJsonResults();
            RoleMethodResults();
        ...
        protected override Cursor? _First(Context _cx)
        {
            ...
            switch (st.name)
            {
                ...
                // level 3 stuff
                case "Role$Arrows": return RoleArrowsBookmark.New(_cx, res);
                ...
                case "Role$Expect": return RoleExpectBookmark.New(_cx, res);
                case "Role$DomainCheck": return RoleDomainCheckBookmark.New(_cx, res);
                case "Role$Graph": return RoleGraphBookmark.New(_cx, res);
                case "Role$GraphNode": return RoleGraphNodeBookmark.New(_cx, res);
                case "Role$GraphScenario": return RoleGraphScenarioBookmark.New(_cx, res);
                ...
                case "Role$SupertypeResults": return RoleSupertypeBookmark.New(_cx, res);
                ...
                case "Role$Union": return RoleUnionBookmark.New(_cx, res);
            ...
            TRow rw) : Cursor(cx, r, pos, new BTree<long,(long,long)>(r.defpos,(dpos,pp)), rw)
        {
            ...
            protected static TypedValue Ref(long? p)
            {
                return new TInt(p??-1L);
            }
        ...
        static void LogResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,1);
            t+=new SystemTableColumn(t, "Desc", Char,0);
            t+=new SystemTableColumn(t, "Type", Char,0);
            t+=new SystemTableColumn(t, "Affects", Int,0);
            t += new SystemTableColumn(t, "Transaction", Int, 0);
            t = t.AddIndex("Ref");
            t.Add();
        }
        /// <summary>
        ...
        internal class LogBookmark : LogSystemBookmark
        {
            ...
            {
                var start = res.Start(_cx, "Ref")?.ToLong() ?? 5;
            ...
            /// <summary>
            /// the current value: (Ref,Desc,Type,Affects,Transaction)
            /// </summary>
        ...
        static void LogDeleteResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,1);
            t+=new SystemTableColumn(t, "DelPos", Int,0);
            t.AddIndex("Ref");
            t.Add();
        }
        /// <summary>
        ...
        internal class LogDeleteBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,DelPos,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
                Delete d = (Delete)ph;
        ...
        static void LogMetadataResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,1);
            t+=new SystemTableColumn(t, "DefPos", Int,0);
            t+=new SystemTableColumn(t, "Name", Char,0);
            t+=new SystemTableColumn(t, "Description", Char,0);
            t+=new SystemTableColumn(t, "RefPos", Int,0);
            t+=new SystemTableColumn(t, "Detail", Char,0);
            t.AddIndex("Ref");
            t.Add();
        }
        internal class LogMetadataBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,DefPos,Name,Proc,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
        ...
        internal class LogUserBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Name,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
                PUser a = (PUser)ph;
        ...
        static void LogCheckResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,1);
            t+=new SystemTableColumn(t, "Int", Int,0);
            t+=new SystemTableColumn(t, "ColRef", Int,0);
            t+=new SystemTableColumn(t, "Name", Char,0);
        ...
        internal class LogCheckBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Int,Name,CheckFields,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
                PCheck c = (PCheck)ph;
        ...
        static void LogClassificationResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,1);
            t+=new SystemTableColumn(t, "Obj", Int,0);
        ...
        internal class LogClassificationBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,User,Clearance,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
        ...
        static void LogClearanceResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,1);
            t+=new SystemTableColumn(t, "User", Int,0);
        ...
        static void LogColumnResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,1);
            t += new SystemTableColumn(t, "Defpos", Int, 0);
            t+=new SystemTableColumn(t, "Table", Int,0);
            t+=new SystemTableColumn(t, "Name", Char,0);
            t+=new SystemTableColumn(t, "Seq", Int,0);
            t+=new SystemTableColumn(t, "Domain", Int,0);
        ...
        internal class LogColumnBookmark: LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Table,Name,Seq.Domain,Default,NotNull,Generate,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
                ...
                return new TRow(res,
                    ...
                    new TChar(c.generation.ToString()));
            }
         }
        /// <summary>
        ...
        static void LogTablePeriodResults()
        {
            ...
            t+=new SystemTableColumn(t, "StartColumn", Int,0);
            t+=new SystemTableColumn(t, "EndColumn", Int,0);
            t.AddIndex("Ref");
            t.Add();
        ...
        internal class LogDateTypeBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Name,DateType,start,end,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
        ...
        internal class LogDomainBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Kind,Name,DataType,DataLength,Scale,Charset,Collate,Default,StructDef,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
        ...
        internal class LogEnforcementBookmark : LogSystemBookmark
        {
            ...
            static TRow _Value(SystemRowSet res, Physical ph)
            {
                ...
                return new TRow(res, Ref(en.ppos), Ref(en.tabledefpos),
                    new TInt((long)en.enforcement),Ref(en.trans));
            }
            protected override Cursor? _Next(Context _cx)
            {
                for (var lb = _cx.db.log.PositionAt(nextpos); lb != null; lb = lb.Next())
        ...
        static void LogGrantResults()
        {
            ...
            t+=new SystemTableColumn(t, "Object", Int,0);
            t+=new SystemTableColumn(t, "Grantee", Int,0);
            t.AddIndex("Ref");
            t.Add();
        }
        /// <summary>
        ...
        internal class LogGrantBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Privilege,Object,Grantee,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
                Grant g = (Grant)ph;
       ...
       //     t+=new SystemTableColumn(t, "Reference", Int,0);
       //     t+=new SystemTableColumn(t, "Adapter", Int,0);
            t.AddIndex("Ref");
            t.Add();
        }
        /// <summary>
        ...
        internal class LogIndexBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Name,Table,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
                    PIndex p = (PIndex)ph;
        ...
        static void LogIndexKeyResults()
        {
            ...
            t+=new SystemTableColumn(t, "Column", Int,0);
            t.AddIndex("Ref");
            t.Add();
        }
        /// <summary>
        ...
        internal class LogIndexKeyBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,ColNo,Column,Transaction)
            /// </summary>
        ...
        static void LogOrderingResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,1);
            t+=new SystemTableColumn(t, "TypeDefPos", Int,0);
            t+=new SystemTableColumn(t, "FuncDefPos", Int,0);
        ...
        internal class LogOrderingBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,TypeDefPos,FuncDefPos,OrderFlags,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
        ...
        static void LogProcedureResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,1);
            t+=new SystemTableColumn(t, "Name", Char,0);
            t+=new SystemTableColumn(t, "RetDefPos", Int,0);
            t+=new SystemTableColumn(t, "Proc", Char,0);
            t+=new SystemTableColumn(t, "Transaction", Int,0);
            t.AddIndex("Ref");
            t.Add();
        ...
        internal class LogProcedureBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Name,Arity,Proc,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
        ...
        internal class LogTriggerBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// The current value: (Ref,name,Table,Flags,OldTable,NewTable,OldRow,NewRow,Def,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
        ...
        static void LogTriggeredActionResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,1);
            t+=new SystemTableColumn(t, "Trigger", Int,0);
            t.AddIndex("Ref");
            t.Add();
        }
        internal class LogTriggeredActionBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,SuperType)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
        ...
        static void LogTypeResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,1);
            t += new SystemTableColumn(t, "Name", Char, 0);
            t+=new SystemTableColumn(t, "SuperType", Int,0);
    //        t += new SystemTableColumn(t, "Graph", Char, 0);
        ...
        internal class LogTypeBookmark : LogSystemBookmark
        {
            ...
            static TRow _Value(SystemRowSet res, Physical ph)
            {
                ...
                if (t.under.Count > 0)
                {
                    ...
                    { sb.Append(cm); cm = ","; sb.Append(Ref(b.key().defpos)); }
        ...
        internal class LogTypeMethodBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Type,Name,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
        ...
        static void LogViewResults()
        {
            ...
            t+=new SystemTableColumn(t, "Struct", Int,0);
            t+=new SystemTableColumn(t, "Using", Int,0);
            t.AddIndex("Ref");
            t.Add();
        }
        /// <summary>
        ...
        internal class LogViewBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Name,Select,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
                PView d = (PView)ph;
        ...
        static void LogRecordResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,1);
            t+=new SystemTableColumn(t, "Table", Int,0);
            t+=new SystemTableColumn(t, "SubType", Int,0);
            t+=new SystemTableColumn(t, "Classification", Char,0);
            t+=new SystemTableColumn(t, "Transaction", Int,0);
            t.AddIndex("Ref");
            t.Add();
        ...
        internal class LogRecordBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// current value: (Ref,Table,SubType,Classification,Transaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
                Record d = (Record)ph;
        ...
        static void LogRecordFieldResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,1);
            t+=new SystemTableColumn(t, "ColRef", Int,1);
        ...
        internal class LogUpdateBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// current value: (Ref,DefPos,Table,SubType,ClassificationTransaction)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
                Update u = (Update)ph;
        ...
        static void LogTransactionResults()
        {
            ...
            t+=new SystemTableColumn(t, "User", Int,0);
            t+=new SystemTableColumn(t, "Role", Int,0);
            t.AddIndex("Ref");
            t.Add();
        }
        /// <summary>
        ...
        internal class LogTransactionBookmark : LogSystemBookmark
        {
            ...
            /// <summary>
            /// current value: (Ref,NRecs,Time,User,Authority)
            /// </summary>
            static TRow _Value(SystemRowSet res, Physical ph)
            {
        ...
        static void SysRoleResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Ref,0);
        ...
        internal class SysRoleBookmark : SystemBookmark
        {
            ...
            SysRoleBookmark(Context _cx, SystemRowSet res,int pos, ABookmark<long,object> bmk)
                : base(_cx,res,pos,bmk.key(),
                      ((Role)bmk.value()).lastChange,_Value(res, (Role)bmk.value(),((Role)bmk.value()).NameFor(_cx)))
            {
                _bmk = bmk;
            }
            ...
            /// <summary>
            /// the current value (Ref,Name,Kind)
            /// </summary>
            static TRow _Value(SystemRowSet res,Role a,string n)
            {
                return new TRow(res,
                    Ref(a.defpos),
                    new TChar(n));
        ...
        internal class SysRoleUserBookmark : SystemBookmark
        {
            ...
            SysRoleUserBookmark(Context _cx, SystemRowSet srs,ABookmark<string,long> rbmk, 
               ...
               ((User?)_cx._Ob(inner.value()) ?? throw new PEException("PE0437")).defpos,  
            ...
            internal static SysRoleUserBookmark? New(Context _cx, SystemRowSet res)
            {
                for (var rb = _cx.db.roles.First(); rb != null; rb = rb.Next())
                    if (_cx._Ob(rb.value()) is Role ro)
                        for (var inner = ro.dbobjects.First(); inner != null; inner = inner.Next())
                            if (_cx._Ob(inner.value()) is User us &&
            ...
            protected override Cursor? _Next(Context _cx)
            {
                ...
                {
                    if (inner.value() is long p && _cx._Ob(p) is User us &&
                    ...
                    while (inner == null)
                    {
                        ...
                        if (rbmk == null || rbmk?.value() is not long rp)
                            return null;
                        var ro = (Role)(_cx._Ob(rp) ?? throw new PEException("PE440"));
                        inner = ro.dbobjects.First();
                    }
                    if (_cx._Ob(inner.value()) is User ns &&
            ...
            {
                if (_cx._Ob(rpos) is not Role ro ||
                    _cx._Ob(upos) is not User us)
                    throw new PEException("PE0450");
                return new TRow(rs,
                    new TChar(ro.NameFor(_cx)),
                    new TChar(us.NameFor(_cx)));
            }
        }
        static void SysAuditResults()
        {
            var t = new SystemTable("Sys$Audit");
            t+=new SystemTableColumn(t, "Ref", Ref,1);
            t+=new SystemTableColumn(t, "User", Char,0);
            t+=new SystemTableColumn(t, "Table", Ref,0);
        ...
        internal class SysAuditBookmark(Context _cx, SystemRowSet res, SystemRowSet.LogBookmark b, int pos) : SystemBookmark(_cx,res,pos,b.ph.ppos,0,_Value(res,b.ph))
        {
            ...
            static TRow _Value(SystemRowSet rs, Physical ph)
            {
                ...
                return new TRow(rs,
                    Ref(au.ppos),
                    new TChar(us.name??""), Ref(au.table),
        ...
        static void SysAuditKeyResults()
        {
            ...
            t+=new SystemTableColumn(t, "Col", Ref,0);
            ...
            ABookmark<long, string> _in, int ix, int pos) : SystemBookmark(_cx, res, pos, bmk.ph.ppos, 0, _Value(res, bmk.ph, _in, ix))
        {
            ...
            {
                return new TRow(res, 
                    Ref(ph.ppos), new TInt(_ix),
                    Ref(_in.key()), new TChar(_in.value()));
            }
        ...
        static void SysClassificationResults()
        {
            ...
            t+=new SystemTableColumn(t, "Type", Char,0);
            t+=new SystemTableColumn(t, "Classification", Char,0);
            t+=new SystemTableColumn(t, "LastTransaction", Ref,0);
            t.AddIndex("Ref");
            t.Add();
        }
        /// <summary>
        ...
        internal class SysClassificationBookmark : SystemBookmark
        {
                ...
                ABookmark<long, TableRow>? tbm)
            {
                if (tbm is not null)
                {
                    ...
                    return (rw.defpos, rw.ppos, new TRow(res, Ref(rw.defpos),
                ...
                else 
                {
                    ...
                    return (ob.defpos, ob.lastChange, new TRow(res, Ref(ppos),
        ...
        static void SysClassifiedColumnDataResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Ref,1);
            t+=new SystemTableColumn(t, "Col", Ref,1);
            t+=new SystemTableColumn(t, "Classification", Char,0);
            t+=new SystemTableColumn(t, "LastTransaction", Ref,0);
            t.AddIndex("Ref", "Col");
            t.Add();
        ...
        internal class SysClassifiedColumnDataBookmark : SystemBookmark
        {
            ...
            SysClassifiedColumnDataBookmark(Context _cx, SystemRowSet res, int pos, 
                ...
                : this(_cx, res, pos, cbm, tbm, _Value(res, tbm.value(), pos))
            { }
            SysClassifiedColumnDataBookmark(Context _cx, SystemRowSet res, int pos,
                ABookmark<long, TableColumn> cbm, ABookmark<long, TableRow> tbm, 
                (long, long, TRow) x)
            ...
            static (long, long, TRow) _Value(SystemRowSet res,TableRow rw, int pos)
            {
                return (rw.defpos,rw.ppos, new TRow(res,
                    Ref(rw.defpos), new TInt(pos),
                    new TChar(rw.classification.ToString()),
                    Ref(rw.ppos)));
            }
            protected override Cursor? _Next(Context _cx)
        ...
        static void RoleUnionResults()
        {

        }
        internal class RoleUnionBookmark : SystemBookmark
        {
            public RoleUnionBookmark(Context cx, SystemRowSet r, int pos, long dpos, long pp, TRow rw) : base(cx, r, pos, dpos, pp, rw)
            {
            }

            internal static Cursor? New(Context cx, SystemRowSet res)
            {
                throw new NotImplementedException();
            }
        ...
        internal class RoleViewBookmark : SystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Name,Select)
            /// </summary>
            static TRow _Value(Context _cx, SystemRowSet rs, long pos, object ob)
            {
                ...
                var us = "";
                if (ob is RestView rv && _cx._Ob(rv.usingTable) is Table tb && tb.infos[ro.defpos] is ObInfo oi)
                        us = oi.name;
                ...
                return new TRow(rs,
                    ...
                    new TChar(st),
                    new TChar(us??""),
                    new TChar(((Role?)_cx._Ob(vw.definer))?.name??""));
            }
            /// <summary>
        ...
        internal class RoleDomainCheckBookmark : SystemBookmark
        {
            ...
            internal static RoleDomainCheckBookmark? New(Context cx, SystemRowSet res)
            {
                ...
                if (bmk.value() is Domain dm){
                    for (var inner = dm?.constraints.First(); inner != null; inner = inner.Next())
                        if (cx._Ob(inner.key()) is Check ck && ck.infos[ro.defpos] is not null)
                        {
            ...
            /// <summary>
            /// the current value: (DomainName,CheckName,Select,Ref)
            /// </summary>
        ...
        internal class RoleTableCheckBookmark : SystemBookmark
        {
            ...
            RoleTableCheckBookmark(Context _cx, SystemRowSet res, int pos, ABookmark<long,object>outer,
               ABookmark<long, bool> inner) 
                : base(_cx,res,pos,inner.key(),((Check?)_cx._Ob(inner.key()))?.lastChange??-1L,
                      _Value(_cx,res, _cx._Ob(inner.key()) ?? throw new PEException("PE0473")))
            {
                _outer = outer;
                _inner = inner;
            }
            ...
            /// <summary>
            /// the current value: (TableName,CheckName,Select,Ref)
            /// </summary>
        ...
        internal class RoleTablePeriodBookmark : SystemBookmark
        {
            ...
            static TRow _Value(Context _cx, SystemRowSet rs, object tb, bool sys)
            {
                ...
                var pd = (PeriodDef)(_cx._Ob(sys ? t.systemPS : t.applicationPS)
        ...
        static void RoleArrowsResults()
        {

        }
        internal class RoleArrowsBookmark :SystemBookmark
        {
            public RoleArrowsBookmark(Context cx, SystemRowSet r, int pos, long dpos, long pp, TRow rw) : base(cx, r, pos, dpos, pp, rw)
            {
            }
        ...
        static void RoleColumnResults()
        {
            ...
            t+=new SystemTableColumn(t, "Name", Char,0);
            t+=new SystemTableColumn(t, "Seq", Int,0);
            t+=new SystemTableColumn(t, "Domain", Char,0);
            t+=new SystemTableColumn(t, "Default", Char,0);
            t+=new SystemTableColumn(t, "Optional", Bool,0);
            t+=new SystemTableColumn(t, "Generated", Char,0);
            t.AddIndex("Ref");
            t.Add();
        }
        ...
        internal class RoleColumnBookmark : SystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Table,Name,Seq,Unique,Domain,Default,NotNull,Generated)
            /// </summary>
            static TRow _Value(Context cx, SystemRowSet rs, object ta, int i,long p,Domain d)
            {
                ...
                if (ta is not Table tb || tb.infos[ro.defpos] is not ObInfo oi
                    || cx._Ob(p) is not TableColumn tc
                ...
                return new TRow(rs,
                    ...
                    new TChar(si.name??""),
                    new TInt(i),
                    (tc.domain is StandardDataType)?new TChar(tc.domain.ToString()):Ref(tc.domain.defpos),
                    new TChar(d.defaultString??""),
                    TBool.For(tc.optional),
                    new TChar(Uid(tc.colDefault)));
            }
            /// <summary>
        ...
        internal class RoleColumnCheckBookmark : SystemBookmark
        {
            ...
            RoleColumnCheckBookmark(Context cx, SystemRowSet res,int pos,ABookmark<long,object>outer,
                ...
                : base(cx,res,pos,inner.key(),((DBObject?)cx._Ob(inner.key()))?.lastChange??-1L,
                ...
                for (var outer = cx.db.objects.PositionAt(0); outer != null;
                    ...
                    if (outer.value() is Table tb && tb.infos[ro.defpos] is ObInfo oi)
                        for (var middle = oi.names.First(); middle != null;
                                middle = middle.Next())
                        if (middle.value().Item2 is long p && cx._Ob(p) is TableColumn tc
                                && tc.infos[ro.defpos] is not null)
                                for (var inner = tc.checks.First(); inner != null;
                                        inner = inner.Next())
                                    if (cx._Ob(inner.key()) is Check)
                                    {
            ...
            /// <summary>
            /// the current value: Table,Column,CheckFields,Select,Ref)
            /// </summary>
            ...
            protected override Cursor? _Next(Context _cx)
            {
                ...
                for (; ; )
                {
                    ...
                    if (middle != null && (middle = middle.Next()) != null)
                        if (middle.value().Item2 is long p && _cx._Ob(p) is TableColumn tc &&
                            tc.infos[ro.defpos] is not null)
                        {
        ...
        internal class RoleColumnPrivilegeBookmark : SystemBookmark
        {
            ...
            static TRow _Value(Context _cx, SystemRowSet rs, object cb,object rb)
            {
                if (rb is not Role ro || cb is not TableColumn tc ||
                    ...
                    _cx._Ob(tc.tabledefpos) is not Table tb ||
                ...
                for (middle = middle.Next(); middle != null; middle = middle.Next())
                    if (middle.value() is QlValue mc)
                        for (inner = _cx.db.objects.PositionAt(0); inner != null; inner = inner.Next())
                            if (_cx._Ob(mc.defpos) is QlValue rc && rc.defpos == mc.defpos)
                            {
                                var rb = new RoleColumnPrivilegeBookmark(_cx,res, _pos + 1, middle, inner);
                                if (rb.Match(res) && Eval(res.where, _cx))
                                    return rb;
        ...
        internal class RoleDomainBookmark : SystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Name,DataType,dataLength,Scale,DefaultValue,NotNull,Struct)
            /// </summary>
        ...
        static void RoleExpectResults()
        {

        }
        internal class RoleExpectBookmark : SystemBookmark
        {
            public RoleExpectBookmark(Context cx, SystemRowSet r, int pos, long dpos, long pp, TRow rw) : base(cx, r, pos, dpos, pp, rw)
            {
            }
        ...
        internal class RoleIndexBookmark : SystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Table,Name,Flags,RefTable,RefIndex,Distinct)
            /// </summary>
            static TRow _Value(Context _cx, SystemRowSet rs, long xp)
            {
                if (_cx._Ob(xp) is not Level3.Index x ||
        ...
        static void RoleIndexKeyResults()
        {
            ...
            t+=new SystemTableColumn(t, "Rowid", Int,1);
            t.AddIndex("IndexName", "Rowid");
            t.Add();
        }
        /// <summary>
        ...
        internal class RoleIndexKeyBookmark : SystemBookmark
        {
                    ...
                    if (outer.value() is Table tb)
                        for (var second = tb.indexes.First(); second != null; second = second.Next())
                            for (var third = second.value().First(); third != null; third = third.Next())
                                if (_cx._Ob(third.key()) is Level3.Index x)
            ...
            /// <summary>
            /// the current value: (Indexname,TableColumn,Int)
            /// </summary>
            ...
            protected override Cursor? _Next(Context _cx)
            {
                ...
                for (third = third.Next();third is not null;third=third.Next())
                    for (inner=((Level3.Index?)_cx._Ob(third.key()))?.keys.First();
                ...
                for (second=second.Next();second is not null;second=second.Next())
                    ...
                    for (inner=((Level3.Index?)_cx._Ob(third.key()))?.keys.First();inner is not null;inner=inner.Next())
                    {
                        var rb = new RoleIndexKeyBookmark(_cx,res, _pos + 1, outer, second, third, inner);
                        if (rb.Match(res) && Eval(res.where, _cx))
                            return rb;
                ...
                for (outer = outer.Next(); outer is not null;outer=outer.Next())
                    if (outer.value() is Table tb)
                        for (second = tb.indexes.First(); second != null; second = second.Next())
                            for (third=second.value()?.First();third is not null;third=third.Next())
                            for (inner = ((Level3.Index?)_cx._Ob(third.key()))?.keys.First(); inner != null;
                                inner = inner.Next())
                            {
                                var rb = new RoleIndexKeyBookmark(_cx,res, _pos + 1, outer, second, third, inner);
                                if (rb.Match(res) && RowSet.Eval(res.where, _cx))
        ...
        internal class RoleProcedureBookmark : SystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Name,Definition)
            /// </summary>
            static TRow _Value(Context _cx, SystemRowSet rs, object ob)
            {
                ...
                if (p.infos[_cx.db.role.defpos] is not ObInfo oi
                    || oi.name == null || _cx._Ob(p.definer) is not Role de)
        ...
        static void RoleSupertypeResults()
        {

        }
        internal class RoleSupertypeBookmark : SystemBookmark
        {
            public RoleSupertypeBookmark(Context cx, SystemRowSet r, int pos, long dpos, long pp, TRow rw) : base(cx, r, pos, dpos, pp, rw)
            {
            }
        ...
        internal class RoleTableBookmark : SystemBookmark
        {
            ...
            /// <summary>
            /// the current value (Ref,Name,Columns,Rows,Triggers,CheckConstraints,Changes,References,Owner)
            /// </summary>
            static TRow _Value(Context _cx, SystemRowSet rs, object ob)
            {
                Table t = (Table)ob;
        ...
        internal class RoleTriggerBookmark : SystemBookmark
        {
                ...
                for (var outer = cx.db.objects.PositionAt(0); outer != null; outer = outer.Next())
                    if (outer.value() is Table t)
                        for (var middle = t.triggers.First(); middle != null; middle = middle.Next())
                            for (var inner = middle.value().First(); inner != null; inner = inner.Next())
                                if (cx._Ob(inner.key()) is Trigger tg)
                                {
            ...
            /// <summary>
            /// the current value: (Ref,name,Flags,TableName,Def)
            /// </summary>
            static TRow _Value(Context _cx, SystemRowSet rs, object ob, Trigger tg)
            {
                ...
                if (_cx.role is not Role ro ||
                    ...
                    _cx._Ob(tg.definer) is not Role de)
            ...
            protected override Cursor? _Next(Context _cx)
            {
                ...
                var inner = _inner;
                for (inner = inner.Next(); inner != null; inner = inner.Next())
                    if (_cx._Ob(inner.key()) is Trigger tg)
                    {
        ...
        internal class RoleTriggerUpdateColumnBookmark : SystemBookmark
        {
            ...
            static TRow _Value(Context _cx, SystemRowSet rs, object ob,Trigger tg,long cp)
            {
                ...
                if (_cx.role is not Role ro || 
                    ...
                    _cx._Ob(cp) is not TableColumn tc ||
        ...
        static void RoleTypeResults()
        {
            ...
            t+=new SystemTableColumn(t, "Ref", Int,0);
            t+=new SystemTableColumn(t, "Name", Char,1);
        ...
        internal class RoleTypeBookmark : SystemBookmark
        {
            ...
            /// <summary>
            /// the current value: (Ref,Name)
            /// </summary>
            static TRow _Value(Context _cx, SystemRowSet rs, object ob)
            {
                var t = _cx._Ob((ob as Table)?.defpos ?? -1) as Table;
                if (_cx.role is null)
                    throw new DBException("42105").Add(Qlx.ROLE);
                TypedValue gr = (t.infos[_cx.role.defpos]?.metadata.Contains(Qlx.EDGETYPE)==true) ? new TChar("EDGETYPE")
                            : (t.infos[_cx.role.defpos]?.metadata.Contains(Qlx.NODETYPE)==true) ? new TChar("NODETYPE") : TNull.Value;
        ...
        internal class RoleMethodBookmark : SystemBookmark
        {
            ...
            {
                var t = (Domain)ob;
                if (_cx.role is not Role ro || _cx._Ob(mp) is not Method p
                    || p.infos[ro.defpos] is not ObInfo mi 
                    || _cx._Ob(p.definer) is not Role de)
        ...
        static void RoleGraphResults()
        {
            var t = new SystemTable("Role$Graph");
            t += new SystemTableColumn(t, "Iri", Char, 0);
            t += new SystemTableColumn(t, "Name", Char, 0);
            t.Add();
        }
        internal class RoleGraphBookmark(Context cx, SystemRowSet r, int pos, ABookmark<string, TypedValue> bmk, TGraph g) 
            : SystemBookmark(cx, r, pos, pos, pos,_Value(cx,r,bmk,g))
        {
            readonly ABookmark<string,TypedValue> _bmk = bmk;

            internal static RoleGraphBookmark? New(Context cx, SystemRowSet res)
            {
                for (var b = cx.db.catalog.First(); b != null; b = b.Next())
                    if (b.value() is TGraph g)
                    {
                        var rb = new RoleGraphBookmark(cx, res, 0, b, g);
                        if (rb.Match(res) && Eval(res.where, cx))
                            return rb;
                    }
                return null;
            ...
            protected override Cursor? _Next(Context cx)
            {
                for (var b = _bmk.Next(); b != null; b = b.Next())
                    if (b.value() is TGraph g)
                    {
                        var rb = new RoleGraphBookmark(cx, res, _pos+1, b, g);
                        if (rb.Match(res) && Eval(res.where, cx))
                            return rb;
                    }
                return null;
            ...
            /// <summary>
            /// the current value: (Ref,PathOrname,Type,Owner)
            /// </summary>
            static TRow _Value(Context cx,SystemRowSet rs, ABookmark<string,TypedValue>bmk, TGraph g)
            {
                var s = bmk.key();
                var ss = s.Split('/');
                return new TRow(rs,
                    new TChar(s),
                    new TChar(ss[ss.Length-1]));
            }
            protected override Cursor? _Previous(Context cx)
            {
                throw new NotImplementedException();
        ...
        static void RoleGraphNodeResults()
        {
            var t = new SystemTable("Role$GraphNode");
            t += new SystemTableColumn(t, "Ref", Int, 1);
            t += new SystemTableColumn(t, "Graph", Char, 0);
            t += new SystemTableColumn(t, "TypeRef", Char, 0);
            t += new SystemTableColumn(t, "Type", Char, 0);
            t.Add();
        }
        internal class RoleGraphNodeBookmark(Context cx, SystemRowSet r, int pos,
            ABookmark<Domain, CTree<long,bool>> outer, ABookmark<long,bool> inner, TGraph g, TNode n) 
            : SystemBookmark(cx, r, pos, n.dataType.defpos, n.defpos, _Value(cx,r, g, n))
        {
            readonly ABookmark<Domain, CTree<long,bool>> _outer = outer;
            readonly TGraph _g = g;
            readonly TNode _n = n;
            readonly ABookmark<long, bool> _inner = inner;

            internal static RoleGraphNodeBookmark? New(Context cx, SystemRowSet res)
            {
                if (cx.graph == null)
                    return null;
                for (var outer = cx.graph.nodes.First(); outer != null; outer = outer.Next())
                    if (outer.key() is Table t)
                        for (var inner = outer.value().First(); inner != null; inner = inner.Next())
                            if (t.tableRows[inner.key()] is TableRow r)
                            {
                                var n = new TNode(cx, r);
                                var rb = new RoleGraphNodeBookmark(cx, res, 0, outer, inner, cx.graph, n);
                                if (rb.Match(res) && Eval(res.where, cx))
                                    return rb;
                            }
                return null;
            ...
            protected override Cursor? _Next(Context cx)
            {
                ...
                for (;;)
                {
                    if (outer == null)
                        return null;
                    if (inner != null && (inner = inner.Next()) != null 
                        && (outer.key() as Table)?.tableRows[inner.key()] is TableRow r)
                    {
                        var rb = new RoleGraphNodeBookmark(cx,res,_pos+1,outer,inner, g, new TNode(cx,r));
                        if (rb.Match(res) && Eval(res.where, cx))
                            return rb;
                    }
                    inner = null;
                    if ((outer = outer.Next()) == null)
                        return null;
                    if (outer.key() is not Table t)
                        continue;
                    inner = outer.value().First();
                    if (inner!=null && t.tableRows[inner.key()] is TableRow s)
                    {
                        var sb = new RoleGraphNodeBookmark(cx, res, _pos + 1, outer, inner, g, new TNode(cx, s));
                        if (sb.Match(res) && Eval(res.where, cx))
                            return sb;
                    }
                }
            ...
            /// <summary>
            /// the current value: (Ref,Graph,TypeRef,TypeName)
            /// </summary>
            static TRow _Value(Context cx,SystemRowSet rs, TGraph g, TNode e)
            {
                return new TRow(rs,
                    new TInt(e.defpos),
                    new TChar(g.iri ?? ""),
                    new TInt(e.dataType.defpos),
                    new TChar(e.dataType.NameFor(cx)));
            }
            protected override Cursor? _Previous(Context cx)
            {
                throw new NotImplementedException();
        ...
        static void RoleGraphScenarioResults()
        {
            var t = new SystemTable("Role$GraphScenario");
            t += new SystemTableColumn(t, "Graph", Char, 0);
            t += new SystemTableColumn(t, "Ref", Int, 1);
            t += new SystemTableColumn(t, "Confidence", Real, 0);
            t += new SystemTableColumn(t, "ValidStart", Timestamp, 0);
            t += new SystemTableColumn(t, "ValidEnd", Timestamp, 0);
            t.Add();
        }
        internal class RoleGraphScenarioBookmark(Context cx, SystemRowSet r, int pos,
            ABookmark<long, bool> bmk, Expectation e, TGraph g)
            : SystemBookmark(cx, r, pos, e.defpos, -1L, _Value(cx, r, g, e))
        {
            readonly ABookmark<long, bool> _bmk = bmk;
            readonly TGraph _g = g;
            readonly Expectation _e = e;

            internal static RoleGraphScenarioBookmark? New(Context cx, SystemRowSet res)
            {
                if (cx.graph == null)
                    return null;
                for (var b = cx.graph.scenarii.First(); b != null; b = b.Next())
                    if (cx.db.objects[b.key()] is Expectation e)
                    {
                        var rb = new RoleGraphScenarioBookmark(cx, res, 0, b, e, cx.graph);
                        if (rb.Match(res) && Eval(res.where, cx))
                            return rb;
                    }
                return null;
            ...
            protected override Cursor? _Next(Context cx)
            {
                ...
                for (var b = _bmk.Next(); b != null; b = b.Next())
                    if (cx.db.objects[b.key()] is Expectation e)
                    {
                        var rb = new RoleGraphScenarioBookmark(cx, res, _pos + 1, b, e, cx.graph);
                        if (rb.Match(res) && Eval(res.where, cx))
                            return rb;
                    }
                return null;
            ...
            /// <summary>
            /// the current value: (Graph,Ref, Confidence, ValidStart, ValidEnd)
            /// </summary>
            static TRow _Value(Context cx, SystemRowSet rs, TGraph g, Expectation e)
            {
                return new TRow(rs,
                    new TChar(g.iri ?? ""),
                    new TInt(e.defpos),
                    new TInt(e.confidence),
                    new TDateTime(e.valid ?? DateTime.Now),
                    new TDateTime(DateTime.Now)); // TBD
            }
            protected override Cursor? _Previous(Context cx)
            {
                throw new NotImplementedException();
        ...
        static void RoleNodeTypeResults()
        {
            ...
            t += new SystemTableColumn(t, "Ref", Char, 1);
            t += new SystemTableColumn(t, "Name", Char, 0);
       //     t += new SystemTableColumn(t, "IdName", Char, 0);
        ...
        internal class RoleNodeTypeBookmark : SystemBookmark
        {
            ...
            RoleNodeTypeBookmark(Context cx, SystemRowSet r, int pos, ABookmark<long, object> fb, Table nt)
            ...
            internal static RoleNodeTypeBookmark? New(Context cx, SystemRowSet res)
            {
                ...
                for (var outer = cx.db.objects.PositionAt(0); outer != null; outer = outer.Next())
                    if (cx._Ob(outer.key()) is Table ut && ut.kind!=Qlx.EDGETYPE)
                    {
            ...
            protected override Cursor? _Next(Context cx)
            {
                for (var fb = _fb.Next(); fb != null; fb = fb.Next())
                    if (cx._Ob(fb.key()) is Table nt && nt.kind != Qlx.EDGETYPE)
                    {
            ...
            static TRow _Value(Context cx, SystemRowSet rs, Table nt)
            {
                return new TRow(rs,
                    Ref(nt.defpos),
        ...
        internal class RolePrivilegeBookmark : SystemBookmark
        {
                ...
                for (var outer = _cx.db.objects.PositionAt(0); outer != null; outer = outer.Next())
                    for (var inner = _cx.db.roles.First(); inner != null; inner = inner.Next())
                        if (outer.value() is DBObject ob && inner.value() is long p &&
                            _cx._Ob(p) is Role ro && ob.infos.Contains(ro.defpos))
                        {
            ...
            static TRow _Value(Context _cx, SystemRowSet rs, object ob,ABookmark<string,long> e)
            {
                ...
                if (_cx.role is not Role sr ||
                    _cx._Ob(p) is not Role ri || t.infos[sr.defpos] is not ObInfo oi
                    || oi.name==null || _cx._Ob(t.definer) is not Role de)
            ...
            protected override Cursor? _Next(Context _cx)
            {
                ...
                for (inner = inner.Next(); inner != null; inner = inner.Next())
                    if (inner.value() is long p &&
                        _cx._Ob(p) is Role ri && ri.infos.Contains(outer.key()))
                    {
                ...
                for (outer = outer.Next(); outer != null; outer = outer.Next())
                    for (inner = _cx.db.roles.First(); inner != null; inner = inner.Next())
                        if (inner.value() is long p && _cx._Ob(p) is Role ri 
