...
namespace Pyrrho.Level2
{
    ...
    public class Writer : IOBase
    {
        ...
        public long seg = -1;    // The SSegment uid for the start of a Commit once roles are defined
                                 //       internal CTree<long, long> uids = CTree<long, long>.Empty; // used for movement of DbObjects
                                 //      internal CTree<long, RowSet> rss = CTree<long, RowSet>.Empty; // ditto RowSets
    ...
    public class Reader : IOBase
    {
        ...
        internal Physical Create()
        {
            ...
            Physical p = tp switch
            {
                ...
                Physical.Type.PUnion => new PUnion(this),
